...
ROOTFS_ISO9660_OPTS += -J -R -volid $(ROOTFS_ISO9660_VOLUME_ID)

define ROOTFS_ISO9660_CONFIGURE_VOLUME_ID
	$(SED) "s%__VOLUME_ID__%$(ROOTFS_ISO9660_VOLUME_ID)%" \
		$(ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATH)
endef
ROOTFS_ISO9660_PRE_GEN_HOOKS += ROOTFS_ISO9660_CONFIGURE_VOLUME_ID
